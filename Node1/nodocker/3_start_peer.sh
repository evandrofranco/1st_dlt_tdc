...
cp -r /home/ubuntu/samples/nodocker/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/msp /var/hyperledger/fabric/msp
cp -r /home/ubuntu/samples/nodocker/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls /var/hyperledger/fabric/tls

export CORE_LOGGING_LEVEL=DEBUG
export CORE_PEER_NETWORKID=peer0.org1.example.com
